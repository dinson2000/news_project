...
<div class="row">
<div class="col-12">
<h2 class="contact-title mb-4">Get in Touch</h2>
</div>
<div class="col-lg-8">
<div class="container-fluid">
    ...
    <div class="form-group">
      ...
      <textarea type="text" textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="message"></textarea>
    </div>
    
      <div class="form-group">
        <label for="exampleFormControlTextarea1">Name:</label>
        <input type="text" textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="name"></textarea>
      </div>
      <div class="form-group">
        <label for="exampleFormControlTextarea1">Email:</label>
        <input type="text" textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="email"></textarea>
      </div>
      <div class="form-group">
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO contact (message,name,email,number,added_on)VALUES('$message','$name','$email','$number','$added_on')";
...
<div class="col-lg-3 offset-lg-1 mt-4 ml-4">
