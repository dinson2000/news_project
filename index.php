...
<h2><a href="article.php?table=headlines&id=<?php echo $row1['id'];?>" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms"><?php echo $row1['headline'];?></a></h2>
...
<h2><a href="article.php?table=headlines&id=<?php echo $row2['id']; ?>"><?php echo $row2['headline'];?></a></h2>
